...
playstore=# SELECT app_name, rating, reviews FROM analytics WHERE rating >= 4.8 ORDER BY rating LIMIT 1;
...
SELECT app_name, price FROM analytics WHERE price BETWEEN 0.1 AND 1;
